...
function msoagendaxpaciente(){
 ...
 //$sql = "SELECT * FROM  agenda a  inner join paciente p on p.id_paciente = a.id_paciente inner join atencion"
  ...
  $sql = "SELECT a.id_agenda,a.prestacion, p.nombre_prestacion, a.fecha_atencion, a.hora_atencion, a.tipo_pago,pg.nombre_pago,"
...
function msoatencionxpaciente(){
 ...
 $id_paciente = $this->getid_paciente();
 $sql = "SELECT * FROM  agenda a  inner join paciente p on p.id_paciente = a.id_paciente inner join atencion"
     . " at on at.id_agenda = a.id_agenda WHERE  p.id_paciente = '$id_paciente' order by at.time_atencion desc";
