...
<?php       
      for($i=0 ; $i < count($arreglo);$i++){
        ...
        ?>
                ...
                <td class="col-3 col-md-1" style="text-align:right;;width:15%" ><div style="order:1;"  ><?php echo $arreglo[$i][2]; ?></div></td>
                <td  style="text-align:right;" hidden <?php echo $hidden; ?> ><div style="order:1;" hidden ><?php echo   $arreglo[$i][3]; ?></div></td>
                <td class="col-3 col-md-3" style="text-align:right;;width:25%" ><div style="order:1;"   ><?php echo $item_price; ?></div></td>
    ...
    <tr>
        ...
        <td class="col-3 col-md-3" style="" align="right" colspan="1"><strong><?php echo "$ ".$total_price; ?></strong></td>
