 ...
 //   document.getElementById(marco).style.border="0px";
  ...
  function showResult(str, opc, origen) {
    ...
    if(origen == 1 ){
     ...
     var tela=0 ;
     if(  origen == 6 ){
         tela = parseInt($("#SEL_CATSBB553").val());
       ...
       data = '?opcion='+opc+'&valor='+str+'&origen='+origen+'&compare='+compare+'&cat_id='+tela;
  if (str.length==0 && str == '') {
    document.getElementById(marco).innerHTML="";
    document.getElementById(marco).style.border="0px";
...
function consultarfinal(){ // cancelado
...
function terminarcompra(obj){
    $('#carrito').removeClass();
     $('#carrito').addClass('col-12 col-md-5 col-lg-5');
  //   $('#divformulario').addClass('col-5 col-md-5 col-lg-5');
   $('#divformulario').attr('hidden', false);
   $('#datoscuenta').attr('hidden', false);
