...
$nombre = strtoupper($nodo->arrobtPaciente[0]['apellido_ppaciente']." ".$nodo->arrobtPaciente[0]['apellido_mpaciente']." ".$nodo->arrobtPaciente[0]['nombre_paciente']);
...
<body onload="cargarfichapaciente(<? echo intval($_GET['id_agenda']);?> ,3)" onunload="">
