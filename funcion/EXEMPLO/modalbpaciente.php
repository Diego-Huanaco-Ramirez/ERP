        ...
        <div class="modal-dialog modal-xl">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">BUSCADOR DE PACIENTES PARA AGENDA </h4>
...
<div class="modal-content">
    ...
    <div class="col-6 col-md-6">
        <input type="text" id="inputnombre"   onkeyup="showResult(this.value, 1,2)" class="form-control"  placeholder="Buscar nombres.." title="Digite un nombre">
    </div>     
    <div class="col-6 col-md-6">
        <input type="text" id="inputapellido"   onkeyup="showResult(this.value, 2,2)" class="form-control"  placeholder="Buscar apellido.." title="Digite un apellido">
    </div>  
    </div>
    <div class="row">
