...
<div class="table-responsive ">
 ...
 //   $json = $json.", 'nombre_especialidad':'".$nodo->arrPacientes[$i]['nombre_especialidad']."' ";
  ...
  <tbody  class=""> 
    ...
    <button id="btn1" onclick="sel(this,<?echo $json; ?>,'2');" class="btn btn-success btn-sm" title="registros"   data-target="#Modalproducto" data-dismiss="modal"  ><i class="far fa-edit"></i></button>
     <? }else{  ?>
      <button id="btn4" onclick="RegistroPaciente(event);sel(this,<?echo $json; ?>,'1');" class="btn btn-info btn-sm" title="Editar registros"  data-toggle="collapse" data-target="#collapseTwo"  onfocusout="" data-dismiss="modal" ><i class="far fa-hand-point-left"></i></button>
    <? }  ?>   
