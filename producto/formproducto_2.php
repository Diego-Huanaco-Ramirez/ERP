      ...
      <div class="owl-carousel owl-theme ">
                        <div class="item mx-3" > 
                            ...
                            <div class="card h-100">
                                <a href="#"><img class="card-img-top" src="../producto/cat6.jpg" alt=""></a>
                              <div class="card-body">
                                  <div class="row text-center">
                                <h4 class="card-title col-12"> <a >Nombre producto1</a> </h4>
                       ...
                       <div class="item mx-3" > 
                            ...
                            <div class="card h-100">
                              ...
                              <div class="card-body">
                                  <div class="row text-center">
                                <h4 class="card-title col-12"> <a >Nombre producto2</a> </h4>
                                <p class="card-text col-md-4 small ">Por Mayor</p>
                                <p class="card-text col-md-4 small">texto2</p>
                                <p class="card-text col-md-4 small">texto3</p>
                                <span class="border-bottom col-12"></span>
                     ...
                     <div class="item mx-3" > 
                            ...
                            <div class="card h-100">
                                <a href="#"><img class="card-img-top" src="../producto/cat177.jpg" alt=""></a>
                              <div class="card-body">
                                  <div class="row text-center">
                                <h4 class="card-title col-12"> <a >Nombre producto3</a> </h4>
                                <p class="card-text col-md-4 small ">Por Mayor</p>
                                <p class="card-text col-md-4 small">texto2</p>
                                <p class="card-text col-md-4 small">texto3</p>
                                <span class="border-bottom col-12"></span>
                       ...
                       <div class="item mx-3" > 
                            ...
                            <div class="card h-100">
                              ...
                              <div class="card-body">
                                  <div class="row text-center">
                                <h4 class="card-title col-12"> <a >Nombre producto4</a> </h4>
                                <p class="card-text col-md-4 small ">Por Mayor</p>
                                <p class="card-text col-md-4 small">texto2</p>
                                <p class="card-text col-md-4 small">texto3</p>
                                <span class="border-bottom col-12"></span>
