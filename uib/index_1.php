...
if($_POST['funcion'] == 'puentes'){
   puentes($_SESSION["cart_item"],0);$bandera = false;
}
...
<div class=" " style="margin-bottom:0;height: 20%;background:#ffffff ;  ">
    ...
    <div class="col-12 col-md-8 col-lg-12">
     ...
     <button id="btn_comprar_tmp"  
        onclick="abrirmodal('#modalsession'); openmodal('modalsession');consultar();"     
...
?> 
   ...
   <nav class="menu navbar navbar-expand-sm bg-dark navbar-dark nosticky"  >
            <a class="navbar-brand" href="#" style="font-weight:bolder ;color: orangered  !important">Si eres:</a>
            ...
            <div class="collapse navbar-collapse sticky2" id="collapsibleNavbar">
                <ul class="navbar-nav" >
                    <li class="nav-item"  >
                        <a class="nav-link" href="index.html" style="font-weight:bolder ;color: orangered  !important">INICIO</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="" style=" font-weight:bolder ;color:orangered !important">E-COMMERCE</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="font-weight:bolder ;color:orangered !important">USUARIO</a>
                    </li>
