...
<body onload="inicio('553')//deshabilitaprod(551);//cargaFuncion();//refrescar2();"  >
    <div id="mi_mensaje">
    ...
    <div class="card"  >
        <div class="card-header bg-ligth " >
                                <a class="collapsed card-link " title="Ficha paciente" data-toggle="collapse" href="#collapseThree" style="color: black;" id="fichapaciente1">
                                   <i class="fas fa-file-medical-alt " style=""></i> test
                                </a>
        </div>
        <div id="collapseThree" class="collapse" data-parent="#accordion">    
            ...
            <div id="" style="height: 500px;overflow-y: auto;overflow-x: hidden;border:1px solid black;">
                  <? $ida= "1"; //formulario($ida);?> 
            </div>
